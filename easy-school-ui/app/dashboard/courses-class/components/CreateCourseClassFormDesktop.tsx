...
import TeacherCalendarListDesktop from '@/app/dashboard/courses-class/components/TeacherCalendarListDesktop';
...
// Props interface for better type safety and documentation
interface CreateCourseClassFormDesktopProps {
...
// Alert components for better reusability
  ...
  <div className="grid grid-cols-2 gap-4">
    ...
    <div className="flex items-end justify-end">
      <Button
        ...
        disabled={isLoading}
        className="hover:bg-purple-500 transition-colors duration-200"
      >
...
// Main component
export default function CreateCourseClassFormDesktop({
  formData,
  message,
  error,
  courses,
  ...
  onCancel,
}: CreateCourseClassFormDesktopProps) {
