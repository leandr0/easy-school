...
const SelectableStudentsTable = forwardRef<SelectableStudentsTableRef, {
  course_class_id: string;
  onSelectionChange: (selectedIds: string[]) => void;
}>(({ course_class_id, onSelectionChange }, ref) => {
  ...
  const loadStudents = async () => {
    try {
      const students = await getStudentsNotInCourseClass(course_class_id);
