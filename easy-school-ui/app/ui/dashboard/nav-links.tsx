...
const links: NavLink[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Categorias', href: '/dashboard/courses/categories' },
      { name: 'Relatórios', href: '/dashboard/courses/reports' }
    ]
  },
  {
    name: 'Turmas',
    ...
    subItems: [
      ...
      { name: 'Cronograma', href: '/dashboard/courses-class/schedule' }
    ]
  },
  {
    ...
    subItems: [
      ...
      { name: 'Avaliações', href: '/dashboard/class-control/evaluations' }
    ]
  },
  {
    name: 'Alunos',
    ...
    subItems: [
      ...
      { name: 'Matrículas', href: '/dashboard/students/enrollments' },
      { name: 'Histórico', href: '/dashboard/students/history' }
    ]
  },
  {
    name: 'Professores',
    ...
    subItems: [
      ...
      { name: 'Horários', href: '/dashboard/teachers/schedules' }
    ]
  },
  {
    name: 'Financeiro',
    ...
    subItems: [
      ...
      { name: 'Pagamentos', href: '/dashboard/financial/payments' },
      { name: 'Mensalidades', href: '/dashboard/financial/tuition' },
      { name: 'Relatórios', href: '/dashboard/financial/reports' }
    ]
  }
];
          ...
          <div key={link.name} className="w-full">
            ...
            <div className="flex items-center">
              <a
                ...
                className="flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3 cursor-pointer"
              >
              ...
              <div className="mt-1 ml-4 md:ml-8 space-y-1">
                {link.subItems.map((subItem) => (
                  <a
                    key={subItem.name}
                    href={subItem.href}
                    className="flex h-[40px] items-center gap-2 rounded-md bg-gray-100 p-2 text-sm font-normal hover:bg-sky-50 hover:text-blue-600 md:px-3"
                  >
