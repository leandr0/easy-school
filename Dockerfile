...
# IMPORTANT: Next.js inlines NEXT_PUBLIC_* variables into the compiled bundle
# at `next build` time - they are NOT read from the environment at container
# runtime. .env / .env.local are intentionally excluded from the Docker build
